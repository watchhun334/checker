...
if (preg_match('/^(\/bat|\.bat|!bat)/', $text)) {
...
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/cookie.txt');
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
'POST /checkout/confirm/7297665e-634f-43fa-b5c0-d291a544d6a9/ ',
'Host: americanchordata.org',
...
'sec-fetch-mode: cors',
'sec-fetch-dest: empty',
'referer: https://americanchordata.org/checkout/confirm/7297665e-634f-43fa-b5c0-d291a544d6a9/',
'accept-language: en-IN,en-US;q=0.9,en;q=0.8',
));
...
elseif(strpos($result3, "Insufficient Funds") || strpos($result3, "insufficient_funds")) {
